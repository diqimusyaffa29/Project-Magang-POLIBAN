            ...
            <header id="main-slide">
                    ...
                    <div class="carousel-inner text-white">
                        <div class="carousel-item active" id="slide1" data-interval="4000">
                            <img src="{{ asset('img/peresmian/66641952_645585115947423_3509919610130399232_o.jpg') }}"
                                alt="" class="d-block w-100" height="1000px">
                        ...
                        <div class="carousel-item" id="slide3" data-interval="4000">
                            <img src="{{ asset('img/peresmian/IMG_6250.JPG') }}" alt="" class="d-block w-100"
                                height="1000px">
                            <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Peresmian
                                    Banjarmasin Plaza Smart City</h3>
                        ...
                        <div class="carousel-item" id="slide3" data-interval="4000">
                            <img src="{{ asset('img/peresmian/IMG_7297.JPG') }}" alt="" class="d-block w-100"
                                height="1000px">
                            <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Peresmian
                                    Banjarmasin Plaza Smart City</h3>
                ...
                <header id="main-slide2">
                    <div class="carousel slide carousel-fade" id="mySlide2" data-ride="carousel">
                        ...
                        <div class="carousel-inner text-white">
                            <div class="carousel-item active" id="slide1" data-interval="4000">
                                <img src="{{ asset('img/fasilitas/IMG_20210524_101342.jpg') }}" alt=""
                                    class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                            ...
                            <div class="carousel-item" id="slide2" data-interval="4000">
                                <img src="{{ asset('img/fasilitas/IMG_20210524_101711.jpg') }}" alt=""
                                    class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Fasilitas
                                        Banjarmasin Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/fasilitas/IMG_20210524_101750.jpg') }}" alt=""
                                    class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Fasilitas
                                        Banjarmasin Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/fasilitas/IMG_20210524_101814.jpg') }}" alt=""
                                    class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Fasilitas
                                        Banjarmasin Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/fasilitas/IMG_20210524_101835.jpg') }}" alt=""
                                    class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Fasilitas
                                        Banjarmasin Smart City</h3>
                ...
                <header id="main-slide2">
                    <div class="carousel slide carousel-fade" id="mySlide3" data-ride="carousel">
                        ...
                        <div class="carousel-inner text-white">
                            <div class="carousel-item active" id="slide1" data-interval="4000">
                                <img src="{{ asset('img/kegiatan/1-2-21....jpeg') }}" alt="" class="d-block w-100" height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                            ...
                            <div class="carousel-item" id="slide2" data-interval="4000">
                                <img src="{{ asset('img/kegiatan/18-3-21.jpeg') }}" alt="" class="d-block w-100"
                                    height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Kegiatan
                                        Sehari-hari Banjarmasin Plaza Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/kegiatan/19-3-21...jpeg') }}" alt="" class="d-block w-100"
                                    height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Kegiatan
                                        Sehari-hari Banjarmasin Plaza Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/kegiatan/2-2-21...jpeg') }}" alt="" class="d-block w-100"
                                    height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Kegiatan
                                        Sehari-hari Banjarmasin Plaza Smart City</h3>
                            ...
                            <div class="carousel-item" id="slide3" data-interval="4000">
                                <img src="{{ asset('img/kegiatan/20200116_111617.jpg') }}" alt="" class="d-block w-100"
                                    height="1000px">
                                <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                    <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Kegiatan
                                        Sehari-hari Banjarmasin Plaza Smart City</h3>
                        ...
                        <div class="carousel-item" id="slide3" data-interval="4000">
                            <img src="{{ asset('img/kegiatan/20200120_103841.jpg') }}" alt="" class="d-block w-100"
                                height="1000px">
                            <div class="carousel-caption d-none d-md-block" style="opacity: 0.9">
                                <h3 class="bg-dark px-2 pb-1 d-inline-block" style="border-radius: 10px">Kegiatan
                                    Sehari-hari Banjarmasin Plaza Smart City</h3>
